...
from wtforms import StringField, RadioField, PasswordField, BooleanField, TextAreaField, DateField, IntegerField
...
class LoginForm(FlaskForm):
    ...
    identity = RadioField('类型', choices=[('0', '教务'), ('1', '教师'), ('2', '学生')], default='2',\
